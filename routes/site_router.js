...
router.route('/p1').get(function(req, res){
	res.render('part1', {title: 'LINKER', bag: build_bag()});
});
...
router.route('/p2').get(function(req, res){
	res.render('part2', {title: 'LINKER', bag: build_bag()});
});
...
// User defnie
// =================================================================================================
router.route('/blocks').get(function(req, res){
	res.render('blocks', {title: 'LINKER', bag: build_bag()});
});
router.route('/blocks/:page?').get(function(req, res){
	res.render('blocks', {title: 'LINKER', bag: build_bag()});
});
